(() => {
    ...
    function initSliders() {
        if (document.querySelector(".product-about")) new core(".image-product__slider", {
            ...
            thumbs: {
                swiper: {
                    el: ".image-preview__slider",
                    slidesPerView: 5
                }
            },
            loop: true,
            pagination: {
                el: ".image-product-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".slide-product__arrows .swiper-button-prev",
                nextEl: ".slide-product__arrows .swiper-button-next"
            },
            on: {}
        });
    }
    ...
    da.init();
    const videoButtons = document.querySelectorAll(".video-product__video");
    videoButtons.forEach((videoButton => {
        videoButton.addEventListener("click", action);
        function action(e) {
            if (e.target.closest(".video-product__video")) videoButton.classList.add("_hide");
        }
    }));
    window["FLS"] = true;
    isWebp();
